...
# Attempt to get the OPENAI_API_KEY from Streamlit's secrets or environment variables for flexibility
OPENAI_API_KEY = st.secrets.get("OPENAI_API_KEY", default=os.getenv("OPENAI_API_KEY"))

if OPENAI_API_KEY is None:
    st.error("OpenAI API key not found. Please set the OPENAI_API_KEY in Streamlit's secrets or as an environment variable.")
    st.stop()
...
if st.button("Send") and user_input:
    # Append user message to session for display
